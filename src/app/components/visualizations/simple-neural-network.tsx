...
import PerceptronHeader from "../../perceptron/components/PerceptronHeader";
import PerceptronLegend from "../../perceptron/components/PerceptronLegend";
import PerceptronControls from "../../perceptron/components/PerceptronControls";
import PerceptronAnimationControls from "../../perceptron/components/PerceptronAnimationControls";
import PerceptronNetworkDiagram from "../../perceptron/components/PerceptronNetworkDiagram";
...
export default function SimpleNeuralNetwork({
  ...
  const [currentAnimationStep, setCurrentAnimationStep] =
    useState(animationStep);
  ...
  const drawNetwork = useCallback(() => {
    ...
    const isHighlighted = (index: number) =>
      isPlaying && currentAnimationStep >= index;
    ...
    nodes.forEach((node, idx) => {
      ...
      const valueText =
        Math.abs(node.value) < 0.0001 ? "0.0000" : node.value.toFixed(4);
  ...
  return (
    <div className="flex flex-col items-center w-full px-2">
      <PerceptronHeader />
      <div className="w-full max-w-2xl aspect-[7/4] relative mb-6">
        <PerceptronNetworkDiagram
          params={params}
      ...
      <div className="w-full max-w-2xl space-y-4">
        <PerceptronAnimationControls
          isPlaying={isPlaying}
          onStart={startAnimation}
          onReset={resetAnimation}
        />
        <PerceptronControls params={params} onParamChange={handleParamChange} />
        <PerceptronLegend />
      </div>
    </div>
  );
